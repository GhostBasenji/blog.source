...
[*Следующая часть: Аутентификация пользователей — регистрация, хэширование пароля и первая связь между таблицами.*](https://ghostbasenji.github.io/posts/part-07-auth-registration/)
