...
date = "2026-05-17"
categories = ["csharp-development", "wpf"]
tags = ["wpf", "csharp", "xaml", "dotnet"]
+++

В этой статье рассматривается простой WPF‑проект **ImageViewer**, который демонстрирует базовую работу с изображениями: загрузку, отображение и простую обработку без использования сторонних библиотек.
<!--more-->
